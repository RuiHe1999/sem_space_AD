...
# 2. consonants
# stopwords
stpw = stopwords.words('english') + ["'s", "'t", "'d", "'m", "'ve", "'ll", 
                                     "'re", "'o", "'y", "'ain", 
                                     'could', 'might', 'must', 'need', 'shall', 
                                     'would', "n't", 'um', 'umm', 'uh', 'uhh', 
                                     'yeah', 'oh', 'ah', 'okay', 'hm', 'mhmm', 
                                     'hmm', 'hmmm', 'well', 'alright']
...
task.to_csv('sem_en.csv', index=False)
